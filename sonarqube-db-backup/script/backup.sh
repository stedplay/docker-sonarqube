...
check_error "PGPASSWORD=${DATABASE_PASSWORD} pg_dump --clean --if-exists --host=${DATABASE_HOST} --username=${DATABASE_USER} --no-password --dbname=${DATABASE_NAME} --file=${DUMP_PATH} 2>&1"
